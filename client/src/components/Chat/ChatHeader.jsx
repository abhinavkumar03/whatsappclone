...
function ChatHeader() {
  ...
  const showContextMenu = (e) => {
    e.preventDefault();
    setContextMenuCordiantes({ x: e.pageX - 50, y: e.pageY + 20 });
  ...
  return <div className="h-16 px-4 py-3 flex justify-between items-center bg-panel-header-background z-10">
    ...
    <div className="flex gap-6 ">
      ...
      <BsThreeDotsVertical className="text-panel-header-icon cursor-pointer text-xl" onClick={(e)=>showContextMenu(e)}
      id="context-opener"/>
      {
